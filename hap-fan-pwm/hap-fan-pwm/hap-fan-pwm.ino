...
#define PMW_FREQUENCY 20

const int FAN_gpio=5;
const int FAN_speed_gpio=15;
const int FAN_direction_gpio=16;
const int FAN_manual_control = 13;
...
const char* HOSTNAME="HOMEKIT-FAN-PWM";
const char* ssid     = "foggyhlw";
...
void set_FANState(bool val){
  ...
  digitalWrite(FAN_gpio, val?LOW:HIGH);
...
void set_FANSpeed(float val){
  analogWrite(FAN_speed_gpio, MAP_100_2_255(val));
  if(hapservice){
